...
(RainyDay.prototype.prepareCanvas = function () {
    ...
    (RainyDay.prototype.setResizeHandler = function () {
        null !== window.onresize
            ? window.setInterval(this.checkSize.bind(this), 100)
            : ((window.onresize = this.checkSize.bind(this)), (window.onorientationchange = this.checkSize.bind(this)));
    }),
        ...
        if (
            (this.reflection !== this.REFLECTION_NONE && this.prepareReflections(),
                ...
                (this.PRIVATE_GRAVITY_FORCE_FACTOR_X =
                    (0.001 * (Math.PI / 2 - this.options.gravityAngle) * this.options.fps) / 50),
        ...
        this.addDropCallback = function () {
            ...
            if (!(b > c - g)) {
                ...
                d.clearRect(0, 0, this.canvas.width, this.canvas.height),
                    d.drawImage(this.background, 0, 0, this.canvas.width, this.canvas.height);
    ...
    (RainyDay.prototype.putDrop = function (a) {
        a.draw(),
            ...
            (this.options.enableCollisions && this.matrix.update(a), this.drops.push(a));
    }),
    ...
    (Drop.prototype.draw = function () {
        ...
        var a = this.r;
        if (((this.r = 0.95 * this.r), this.r < 3))
            this.context.arc(this.x, this.y, this.r, 0, 2 * Math.PI, !0), this.context.closePath();
        ...
        } else this.context.arc(this.x, this.y, 0.9 * this.r, 0, 2 * Math.PI, !0), this.context.closePath();
        this.context.clip(),
            (this.r = a),
    ...
    (Drop.prototype.clear = function (a) {
        return (
            ...
            a
                ? ((this.terminate = !0), !0)
                : this.y - this.r > this.rainyday.h || this.x - this.r > this.rainyday.w || this.x + this.r < 0
                    ? !0
                    : !1
        );
    }),
    ...
    (RainyDay.prototype.TRAIL_DROPS = function (a) {
        (!a.trailY || a.y - a.trailY >= 100 * Math.random() * a.r) &&
            ((a.trailY = a.y),
                this.putDrop(
                    new Drop(this, a.x + (2 * Math.random() - 1) * Math.random(), a.y - a.r - 5, Math.ceil(a.r / 5), 0)
                ));
    }),
    ...
    (RainyDay.prototype.GRAVITY_LINEAR = function (a) {
        return this.clearDrop(a)
            ? !0
            : (a.yspeed
                ? ((a.yspeed += this.PRIVATE_GRAVITY_FORCE_FACTOR_Y * Math.floor(a.r)),
                    (a.xspeed += this.PRIVATE_GRAVITY_FORCE_FACTOR_X * Math.floor(a.r)))
                ...
                a.yspeed
                    ? a.slowing
                        ...
                        : a.skipping
                            ? ((a.yspeed = this.PRIVATE_GRAVITY_FORCE_FACTOR_Y),
                                (a.xspeed = this.PRIVATE_GRAVITY_FORCE_FACTOR_X))
                            : ((a.yspeed += 1 * this.PRIVATE_GRAVITY_FORCE_FACTOR_Y * Math.floor(a.r)),
                                (a.xspeed += 1 * this.PRIVATE_GRAVITY_FORCE_FACTOR_X * Math.floor(a.r)))
                    : ((a.yspeed = this.PRIVATE_GRAVITY_FORCE_FACTOR_Y),
                        (a.xspeed = this.PRIVATE_GRAVITY_FORCE_FACTOR_X)),
                0 !== this.options.gravityAngleVariance &&
                (a.xspeed += (2 * Math.random() - 1) * a.yspeed * this.options.gravityAngleVariance),
                (a.y += a.yspeed),
                (a.x += a.xspeed),
                a.draw(),
                !1);
    ...
    (RainyDay.prototype.REFLECTION_MINIATURE = function (a) {
        var b = Math.max((a.x - this.options.reflectionDropMappingWidth) / this.options.reflectionScaledownFactor, 0),
            ...
            d = this.positiveMin(
                (2 * this.options.reflectionDropMappingWidth) / this.options.reflectionScaledownFactor,
                this.reflected.width - b
            ),
            e = this.positiveMin(
                (2 * this.options.reflectionDropMappingHeight) / this.options.reflectionScaledownFactor,
    ...
    (CollisionMatrix.prototype.update = function (a, b) {
        if (a.gid) {
            ...
            if (
                ((a.gid = Math.random().toString(36).substr(2, 9)),
                    (a.gmx = Math.floor(a.x / this.resolution)),
                    (a.gmy = Math.floor(a.y / this.resolution)),
                    !this.matrix[a.gmx] || !this.matrix[a.gmx][a.gmy])
            )
