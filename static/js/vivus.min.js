  ...
  (t.prototype.TYPES = [
    ...
    (a.prototype.setElement = function (t, e) {
      ...
      if (((this.parentEl = t), e && e.file)) {
        ...
        return (
          i.addEventListener("load", r), i.open("GET", e.file), void i.send()
        );
      }
      var a = "" + t.constructor,
    ...
    (a.prototype.setOptions = function (t) {
      ...
      if (
        ...
        (this.duration = i(t.duration, 120)),
        (this.delay = i(t.delay, null)),
        (this.dashGap = i(t.dashGap, 1)),
        ...
        (this.animTimingFunction = t.animTimingFunction || a.LINEAR),
        (this.pathTimingFunction = t.pathTimingFunction || a.LINEAR),
    ...
    (a.prototype.mapping = function () {
          ...
          this.isInvisible(r) ||
            ...
            isNaN(a.length)
              ...
              : (this.map.push(a),
                ...
                (r.style.strokeDashoffset = a.length + this.dashGap),
      ...
      for (
        ...
        switch (((a = this.map[t]), this.type)) {
          case "delayed":
            (a.startAt = this.delayUnit * t),
              (a.duration = this.duration - this.delay);
            break;
          case "oneByOne":
            (a.startAt = (s / o) * this.duration),
              (a.duration = (a.length / o) * this.duration);
            break;
          case "sync":
          case "async":
          case "nsync":
          ...
          case "scenario-sync":
            (r = a.el),
              (n = this.parseAttr(r)),
              (a.startAt = h + (i(n["data-delay"], this.delayUnit) || 0)),
              (a.duration = i(n["data-duration"], this.duration)),
              (h =
                void 0 !== n["data-async"]
                  ? a.startAt
          ...
          case "scenario":
            (r = a.el),
              (n = this.parseAttr(r)),
              (a.startAt = i(n["data-start"], this.delayUnit) || 0),
              (a.duration = i(n["data-duration"], this.duration)),
              (this.frameLength = Math.max(
                this.frameLength,
                a.startAt + a.duration
    ...
    (e = function () {
      a.prototype.docElem ||
        ((a.prototype.docElem = window.document.documentElement),
        (r =
